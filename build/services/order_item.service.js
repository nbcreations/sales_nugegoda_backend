...
var order_item_add = function (data) { return __awaiter(void 0, void 0, void 0, function () {
    var result, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                result = void 0;
                return [4 /*yield*/, order_item_model_1.default.order_item_add(data.orderId, data.product, data.price, data.qty, data.authUserId)];
            case 1:
                result = _a.sent();
