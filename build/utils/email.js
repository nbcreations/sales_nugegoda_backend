...
*/
var emailSend = function email(toEmail, subject, message) {
    if (toEmail === void 0) { toEmail = "contact@kavindunimesh.com"; }
    if (subject === void 0) { subject = "test"; }
    if (message === void 0) { message = ""; }
    return __awaiter(this, void 0, void 0, function () {
        var transporter, response, error_1, error_2;
            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, transporter.sendMail({
                            from: "\"".concat(config_1.default.email.smtp.auth.user, "\" <").concat(config_1.default.email.from, ">"),
                            to: toEmail,
                            subject: subject,
                            html: message,
                        })];
