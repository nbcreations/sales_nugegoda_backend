...
var dev_service_1 = __importDefault(require("../services/dev.service"));
var dev_validate_1 = __importDefault(require("./../validate/dev.validate"));
...
var sql_run = (0, catchAsync_1.default)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var data, authData, result, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
                return [4 /*yield*/, (0, validate_1.default)(req.body, dev_validate_1.default.sql_run)];
            case 1:
                data = _a.sent();
                if (!data.status) {
                ...
                authData = (0, authorize_1.default)('dev', 'sql_run', req);
                if (!authData.status) {
                ...
                return [4 /*yield*/, dev_service_1.default.sql_run(data.data)];
            case 2:
                result = _a.sent();
