...
var product_category_list = function () { return __awaiter(void 0, void 0, void 0, function () {
    var result, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, db_1.default.query("SELECT product_category.id, product_category.name, product_category.status, product_category.added_by, product_category.added_time, product_category.updated_by, product_category.updated_time\n        FROM product_category\n        WHERE product_category.status != ?  ORDER BY product_category.id DESC", [403])];
            case 1:
                result = _a.sent();
