...
var order_item_add = function (orderId, product, price, qty, authUserId) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, db_1.default.query('INSERT INTO `order_item`(order_id, product, price, qty, added_by, added_time) VALUES (?, ?, ?, ?, ?, ?)', [orderId, product, price, qty, authUserId, currentDateTime])];
            case 1:
                result = _a.sent();
                if (result.status) {
