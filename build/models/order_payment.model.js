...
var order_payment_add = function (orderId, amount, type, authUserId) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, db_1.default.query('INSERT INTO `order_payment`(order_id, amount, type, added_by, added_time) VALUES (?, ?, ?, ?, ?)', [orderId, amount, type, authUserId, currentDateTime])];
            case 1:
                result = _a.sent();
                if (result.status) {
...
var order_payment_history = function (orderId) { return __awaiter(void 0, void 0, void 0, function () {
    var result, err_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, db_1.default.query("SELECT order_payment.id, order_payment.order_id, order_payment.amount, order_payment.type, order_payment.added_time\n        FROM order_payment\n        WHERE order_payment.order_id = ?  ORDER BY order_payment.id DESC", [orderId])];
            case 1:
                result = _a.sent();
                return [2 /*return*/, result];
            case 2:
...
//# sourceMappingURL=order_payment.model.js.map