...
var authenticate = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var token_1, check, data, result, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 5, , 6]);
                if (!(req.headers.authorization && req.headers.authorization.startsWith('Bearer'))) return [3 /*break*/, 3];
                token_1 = req.headers.authorization.split(' ')[1];
                if (token_1 == null) {
                    DefaultResponse_1.default.error(res, '401');
                    return [2 /*return*/];
                }
                check = new Promise(function (resolve) {
                    jsonwebtoken_1.default.verify(token_1, config_1.default.jwt_access_key, function (err, data) {
                        if (err) {
                            resolve({
                                status: false,
                            });
            ...
            case 1:
                ...
                return [4 /*yield*/, db_1.default.query("\n                SELECT user.password\n                FROM user\n                WHERE user.status = 1 && user.id = ? && user.role = ?", [data.data.user, data.data.role])];
            case 2:
                result = _a.sent();
                if (!result.status) {
